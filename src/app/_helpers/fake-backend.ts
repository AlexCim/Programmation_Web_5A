...
export class FakeBackendInterceptor implements HttpInterceptor {
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        function basicDetails(account) {
            const { id, title, firstName, lastName, numero, licence, email, role, dateCreated, isVerified } = account;
            return { id, title, firstName, lastName, numero, licence, email, role, dateCreated, isVerified };
        }
